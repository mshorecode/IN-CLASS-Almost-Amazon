...
const showAuthors = (array) => {
  ...
  let domString = '';
  if (array.length < 1) {
    domString += '<p style="color: white;">No Authors Found</p>';
  } else {
    array.forEach((item) => {
      domString += `
      <div class="card" style="width: 18rem;">
        <div class="card-body">
          ...
          <hr>
          <p class="card-text bold">${item.favorite ? `<span class="badge badge-info sale-badge" style="background-color: #A10500;">Favorited</span> ${''}` : ''}</p>
